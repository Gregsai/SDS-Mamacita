...
@Component({
  selector: 'app-cultural-ressources-details',
  templateUrl: './cultural-ressources-details.component.html',
  styleUrls: ['./cultural-ressources-details.component.css']
})
export class CulturalRessourcesDetailsComponent implements OnInit {
